    ...
    selection_toolbars.forEach(element => {
        ...
        element.addEventListener('click', function(event) {
                 ...
                 event.target.getAttribute != actualData ) 
            {
                ...
                element.setAttribute('data-display', optionSelected.getAttribute('data-display'));

                if ( optionActive )
                    optionActive.classList.remove('option--active');
...
export function setEarsForVendorSelection() {
    ...
    selection_toolbars.forEach(element => {
        ...
        // Focus & Blur Handlers..
        element.querySelector('input').addEventListener('focusin', function(e) {
        ...
        element.addEventListener('click', function(e) {
            ...
            if ( e.target.tagName == 'LI' ) {
                ...
                element.querySelector('.vendor__avatar img').src = `../assets/vendors/${newData}.png`;
            }
