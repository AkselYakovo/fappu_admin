...
<body>
    ...
    <div id="New-Children-Website-Modal" class="modal children-website-modal edit">
        <section class="picture">
            <div class="controls">
                <button class="button button-secondary button-x-small remove">REMOVE SCREEN</button>
                <button class="button button-secondary button-x-small remove-logo">REMOVE LOGO</button>
                <button class="button button-secondary button-x-small zoom-in">ZOOM IN</button>
                <button class="button button-secondary button-x-small zoom-out">ZOOM OUT</button>
            </div>
            <img class="embed-picture" style="transform: scale(1.0)" draggable="false">
            <figure class="logotype">
                <img src="" title="Logo">
            </figure>
            <button class="add-picture" for="Subsite-Image">
                <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M64 76H8V20H44V12H8C3.6 12 0 15.6 0 20V76C0 80.4 3.6 84 8 84H64C68.4 84 72 80.4 72 76V40H64V76ZM32.84 63.32L25 53.88L14 68H58L43.84 49.16L32.84 63.32ZM72 12V0H64V12H52C52.04 12.04 52 20 52 20H64V31.96C64.04 32 72 31.96 72 31.96V20H84V12H72Z"/>
                </svg>
                <p>SELECT AN IMAGE</p>
            </button>
        ...
        <section class="information-input">
            <div class="row">
                ...
                <div class="toolbar price-input">
                    <input type="text" name="Subsite's Title" placeholder="CRAZYTETONAS" autocomplete="off">
        ...
        <form action="" style="display: none;">
            <input type="file" name="Subsite Image" id="Subsite-Image" accept="image/*">
    ...
    <div id="New-Website-Modal" class="new-website-modal modal">
        ...
        <div class="information">
            <header>
                <div class="toolbar price-input site-code">
                    <input type="text" placeholder="CODE" name="Site Code">
                    <figure class="underline"></figure>
                </div>
                <div class="toolbar url-input top">
                    <input type="text" placeholder="website.com" name="URL Input">
                </div>
            </header>
            ...
            <div class="content">
                <div class="strip">
                    ...
                    <div class="row">
                        <span class="label">SITE&apos;S TITLE:</span>
                        <div class="toolbar price-input">
                            <input type="text" placeholder="LATINAS CALIENTES" name="Site Title">
                            <figure class="underline"></figure>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <button class="button button-primary ico-button" name="Logotype">
                            <svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 13H10V7H14L7 0L0 7H4V13ZM0 15H14V17H0V15Z"/>
                            </svg>
                            <p>UPLOAD</p>
            ...
            <button class="button button-secondary next">NEXT</button>
        ...
        <form style="display: none;">
            <input type="file" name="Files" id="" accept="image/jpeg" multiple="on" maxlength="3">
        </form>
    </div>
    <div class="overlay"></div>
